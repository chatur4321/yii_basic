...
class SiteController extends Controller
{
    ...
    public function actionContact()
    {
      ...
      //Receive the phone number posted by a user in the Login form.
      //Find the user by phone number and incase user doesn’t exist, it’ll create one with that number.
      //Set a random 6-digit OTP and send it using Twilio SMS.
      //Return a success or failure (with error message) response in JSON format.
